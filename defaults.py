...
def app(name, slug, **kwargs):
    ...
    data = {
        ...
        'upsell': False,
        'content_ratings': {
            'br': [{'body': 'CLASSIND', 'name': '12+',
                    'body_slug': 'classind', 'slug': '12',
                    'description': text('Ask your parents')}],
            'de': [{'body': 'USK', 'name': '0+',
                    'body_slug': 'usk', 'slug': '0',
                    'description': text('General Audiences')}],
            'es': [{'body': 'PEGI', 'name': '13+',
                    'body_slug': 'pegi', 'slug': '13',
                    'description': text('ull shot ur eyez out')}],
            'us': [{'body': 'ESRB', 'name': '0+',
                    'body_slug': 'esrb', 'slug': '0',
                    'description': text('L for BASTA')}],
            'generic': [{'body': 'GENERIC', 'name': '3+',
                         'body_slug': 'generic', 'slug': '3',
